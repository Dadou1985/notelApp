    ...
    return(
        <div className="messenger_container">
            ...
            centered>
                ...
                <Modal.Body>
                    <Input type="textarea" placeholder="Rédiger une note..." value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none", height: "5vh", }} onChange={handleChange} required />
                </Modal.Body>

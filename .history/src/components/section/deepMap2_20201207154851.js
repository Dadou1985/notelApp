...
import { paris_arrondissementile_de_france, auvergne_rhone_alpes, bourgogne_franche_comte, bretagne, centre_val_de_loire, corse, grand_est, hauts_de_france, normandie, nouvelle_aquitaine, occitanie, pays_de_la_loire,provence_alpes_cote_d_azur } from "../../../hotels"
                            ...
                            <Modal show={list}
                                ...
                                onClick={(event) => {
                                    ...
                                    firebase.addCommentOnHotel({
                                        ...
                                        departement: selectedHotel.departement,

...
import DepartementDetails from '../../../hotels/departementDetailsSheet/idfDetailsSheet.json.json'
            ...
            <div style={{
                ...
                {RegionDetails.map(details => (
                    <Dropdown.Item  onClick={()=>{
                        ...
                        handleDepartement(details.region, details.coordinates[0], details.coordinates[1])}}>{details.region}</Dropdown.Item>
                    ))}
                </DropdownButton>
                </Form.Group>

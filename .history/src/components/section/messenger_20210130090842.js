    ...
    return(
        <div className="messenger_container">
            ...
            centered>
                ...
                <Modal.Body>
                    <Input type="textarea" placeholder="Rédiger une note..." value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none", height: "15vh", minHeight: "5vh", maxHeight: "15vh"}} onChange={handleChange} required />
                </Modal.Body>

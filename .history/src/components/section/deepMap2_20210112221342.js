                            ...
                            <Modal show={list}
                                ...
                                onClick={(event) => {
                                    ...
                                    firebase.addCommentOnHotel({
                                        ...
                                        team: formValue.team.push(formValue.team),
                                        management: formValue.management.push(formValue.management),
                                        customer: formValue.customer.push(formValue.customer),
                                        wage: formValue.wage.push(formValue.wage)})

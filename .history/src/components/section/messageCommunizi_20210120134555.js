...
const renderSwitch = (mood) => {
  switch(mood) {
    case 'angry':
      return <span style={{marginBottom: "2%", color: "red", fontSize: "2em", fontFamily: "Time new roman"}}>{text}</span>;
    case 'happy':
    ...
    case 'depressed':
      return <span style={{marginBottom: "2%", color: "purple", fontFamily: "Reenie Beanie"}}>{text}</span>;
    case 'emergency':

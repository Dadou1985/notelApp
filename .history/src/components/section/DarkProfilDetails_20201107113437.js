...
export default function DarkProfilDetails({firebase, user}) {
    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        setFormValue("")
        firebase.updateIziProfile({username: user.username, job: formValue.job, level: formValue.level, mood: formValue.client, markup: marker, date: formValue.date, hour: formValue.hour, destination: formValue.destination, pax: formValue.passenger, model: formValue.model}).then(handleClose)
    }

                            ...
                            <Tab eventKey="Créer" title="Créer un espace de travail">
                                <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Input type="text" placeholder="Donner un nom à votre espace de travail..." style={{width: "25vw", border: "none",}} value={createRefSpace} name="createRefSpace" onChange={handleChangeCreate} />
                                    </Form.Row>

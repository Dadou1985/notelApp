            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <ul style={{position: "absolute", zIndex: "6", listStyleType: "none", bottom: "15%", left: "28vw"}} id="moodList" className="moodList">
                        <li onClick={() => {
                          setMood("angry")
                          handleMoodList()}}><img src={AngryBear} alt="angry" className="moodListIcon" /></li>
                        <li onClick={() => {
                          setMood("happy")
                          handleHideMoodList()}}><img src={Smile} alt="smile" className="moodListIcon" /></li>
                        <li onClick={() => {
                          setMood("scared")
                          handleHideMoodList()}}><img src={Scared} alt="scared" className="moodListIcon" /></li>
                        <li onClick={() => {
                          setMood("depressed")
                          handleHideMoodList()}}><img src={LowBattery} alt="lowBattery" className="moodListIcon" /></li>
                        <li onClick={() => {
                          setMood("emergency")
                          handleHideMoodList()}}><img src={Emergency} alt="emergency" className="moodListIcon" /></li>
                        <li onClick={() => {
                          setMood("")
                          handleHideMoodList()}}><img src={Chill} alt="chill" className="moodListIcon" /></li>
                    </ul>
                </Form>
            </div>
        </div>

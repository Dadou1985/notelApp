...
const Messenger = () =>{
    ...
    const renderSwitch = (status) => {
        switch(status) {
          case 'important':
            return <img src={YellowCircle} alt="important" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
          case 'urgent':
            return <img src={RedCircle} alt="urgent" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
          default:
            return <img src={BlueCircle} alt="info" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
        }
      }

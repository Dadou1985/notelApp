                                ...
                                <Divider style={{height: "1vh", marginBottom: "4vh"}} />
                                    ...
                                    marginTop: "4vh"
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{managementRate.length > 0 ? <Typography component="legend"></Typography>
                                                    <Rating
                                                    name="team"
                                                    value={teamRate.reduce(reducer)/teamRate.length}
                                                    onChange={handleChange}
                                                    precision={0.5}
                                                    />managementRate.reduce(reducer)/managementRate.length : "No rate"}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",

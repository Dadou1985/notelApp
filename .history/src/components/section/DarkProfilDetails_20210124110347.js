        ...
        info.map(flow =>(
            <div style={{
                ...
                <Form.Row>
                    ...
                    <select class="selectpicker" value={formValue.job} placeholder={flow.job} name="job" onChange={handleChange} 
                    style={{width: "20vw", 
                    height: "6vh", 
                ...
                <Form.Row>
                    ...
                    <select class="selectpicker" value={formValue.level} defaultValue={flow.category} name="level" onChange={handleChange} 
                    style={{width: "20vw", 
                    height: "6vh", 
                    border: "1px solid lightgrey", 
                    borderRadius: "3px",

            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <ul style={{position: "absolute", zIndex: "6", listStyleType: "none", bottom: "15%", left: "28vw"}} id="moodList">
                        <li onClick="angry"><img src={AngryBear} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick="smile"><img src={Smile} alt="smile" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick="scared"><img src={Scared} alt="scared" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick="lowBattery"><img src={LowBattery} alt="lowBattery" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick="angry"><img src={Emergency} alt="emergency" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick="angry"><img src={Chill} alt="chill" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                    </ul>
                </Form>
            </div>
        </div>

        ...
        <div className="messenger_container">
            ...
            centered>
                ...
                <Modal.Title id="example-modal-sizes-title-sm" style={{width: "100%"}}>
                    <Input type="textarea" name="title" placeholder="Donner un titre à la note..." style={{border: "none", width: "100%"}} required />
                </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Input type="text" placeholder="Rédiger une note..." value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none"}} maxLength="60" onChange={handleChange} />
                </Modal.Body>

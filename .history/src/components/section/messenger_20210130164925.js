        ...
        <div className="messenger_container">
            ...
            centered>
                ...
                <Modal.Title id="example-modal-sizes-title-sm" style={{width: "100%"}}>
                    <Input type="text" name="title" placeholder="Donner un titre à la note..." style={{border: "none", width: "100%", color: "black", fontWeight: "100", backgroundColor: ""}} maxLength="60" onChange={handleChangeTitle} required />
                </Modal.Title>
                </Modal.Header>
                <Modal.Body>

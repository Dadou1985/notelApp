...
const Clock = () =>{
    ...
    const handleSubmit = event => {
        ...
        let marker = Date.now()
        db.addClock({hotelId: user.displayName, author: user.username, room: formValue.room, day: formValue.date, client: formValue.client, markup: marker, date: time, hour: formValue.hour}).then(handleClose)
    }

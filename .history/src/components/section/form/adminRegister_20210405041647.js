...
const AdminRegister = ({hide}) => {
    ...
    const [formValue, setFormValue] = useState({username: "", refHotel: "", email: ""})
    ...
    const handleSubmit = (event) => {
        ...
        setFormValue("")
            db.createTeammate({username: formValue.username, hotelId: userDB.hotelId, email: formValue.email})
        hide()
      }

                    ...
                    <Tabs defaultActiveKey="Ajouter un contact" id="annuaire">
                            ...
                            <div style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Control type="text" placeholder="ex: 0656872674" style={{width: "10vw"}} value={formValue.mobile} name="mobile" onChange={handleChange} />
                                        </Form.Group>
                                    
                                        <Form.Group controlId="description">
                                        <Form.Label>Numéro de fixe</Form.Label>
                                        <Form.Control type="text" placeholder="ex: 0130987654" style={{width: "10vw"}} value={formValue.fix} name="fix" onChange={handleChange} />
                                        </Form.Group>
                                    </Form.Row>
                                </div>
                            </Tab>

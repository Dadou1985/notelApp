    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        return db.addMaid({
            ...
            author: user.displayName, fromRoom: formValue.fromRoom, client: formValue.client, markup: marker, date: time, toRoom: formValue.toRoom, reason: formValue.reason, details: formValue.details, state: formValue.state}).then(handleClose)
    }

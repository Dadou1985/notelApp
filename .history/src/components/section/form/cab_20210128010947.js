    ...
    return(
        <div>
            ...
            <Modal show={list}
                    ...
                    <Tabs defaultActiveKey="Réserver" id="uncontrolled-tab-example" style={{backgroundColor:"transparent"}}>
                            <Tab eventKey="Réserver" title="Réserver un taxi" style={{backgroundColor:"transparent"}}>
                                <div  style={{
                                    display: "flex",
                                    flexFlow: "column",
                            ...
                            <Tab eventKey="Liste des réservations" title="Liste des réservations" style={{backgroundColor:"transparent"}}>
                            <Table striped bordered hover size="sm" className="text-center" style={{backgroundColor:"transparent"}}>

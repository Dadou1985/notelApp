            ...
            <Modal show={list}
                    ...
                    <div style={{
                            ...
                            <Form.Row>
                                ...
                                placeholder="Faites-nous un retour de votre expérience..." style={{width: "35vw", height: "30vh", resize: "none"}} value={formValue.feedback} name="feedback" onChange={handleChange} />
                                </Form.Group>
                            </Form.Row>
                        </div>
                    </Modal.Body>

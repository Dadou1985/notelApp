    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        return db.addLostFound({
            ...
            author: user.displayName, date: time, type: formValue.type, markup: marker, place: formValue.place, details: formValue.details, description: formValue.description}).then(handleClose)
    }

...
const Caisse = () =>{
    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        handleReset()
        db.addSafe({hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, author: user.username, amount: caisse, date: time, markup: marker, shift: formValue.shift}).then(handleClose)
    }

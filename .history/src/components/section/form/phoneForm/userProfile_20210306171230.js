            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    <div style={{
                        ...
                        <div><input type="text" name="hotelName" value={formValue.hotelName} placeholder="Titre de la note" className="user-dialog-title" onChange={handleChange} required /></div>

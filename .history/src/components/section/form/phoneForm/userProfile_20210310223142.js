            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    <div style={{
                        ...
                        <div cla><input type="text" name="hotelName" value={formValue.hotelName} placeholder="Titre de la note" className="user-dialog-hotel" onChange={handleChange} required /></div>

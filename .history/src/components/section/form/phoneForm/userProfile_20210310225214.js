            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    ...
                    <div className="drawer-container">
                        <div><input type="text" name="hotelName" value={formValue.hotelName === "" ? formValue.hotelName : flow.hotelName} placeholder="Titre de la note" className="user-dialog-hotel" onChange={handleChange} required /></div>

            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    ...
                    <div className="drawer-container">
                        <div><input type="text" name="hotelName" value={formValue.hotelName === "" ? flow.hotelName : formValue.hote} placeholder="Titre de la note" className="user-dialog-hotel" onChange={handleChange} required /></div>

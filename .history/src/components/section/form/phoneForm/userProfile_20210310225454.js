            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    ...
                    <div className="drawer-container">
                        ...
                        <div><input type="text" name="level" value={formValue.level} placeholder={flow.level} className="user-dialog-level" onChange={handleChange} required /></div>
                    </div>
                    <Button variant="success" onClick={}>Actualiser</Button>
                </Drawer>
            </div>
        ))
    )

            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    ...
                    <div className="drawer-container">
                        <div><input type="text" name="hotelName" value={value === null ? flow.hotelName : formValue.hotelName} placeholder={flow.hotelName} className="user-dialog-hotel" onChange={handleChange} required /></div>
                    ...
                    <Button variant="success" size="lg" onClick={()=> {
                        if(formValue === ""){
                            setFormValue({hotelName: flow.hotelName, job: flow.job, level: flow.category})
                        }
                        handleSubmit()
                    }}>Actualiser</Button>
                </Drawer>

            ...
            <div>
                ...
                <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                    ...
                    <div className="drawer-container">
                        <div><input type="text" name="hotelName" value={value !== nullformValue.hotelName} placeholder={flow.hotelName} className="user-dialog-hotel" onChange={handleChange} required /></div>

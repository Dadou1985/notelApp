    ...
    return (
        info.map(flow => (
            <div>
                ...
                <input accept="image/*" style={{display: "none"}} id="icon-button-file" type="file" onChange= />
                ...
                <div style={{
                    ...
                    <img src={Home} alt="Home" style={{width: "10%", filter: "drop-shadow(1px 1px 1px)"}} onClick={() => navigate('/doorsStage')} />
                </div>

...
const Repair = () =>{
    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        let marker = Date.now()
        return db.addMaintenance({
            hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, author: user.displayName, room: formValue.room, client: formValue.client, markup: marker, date: time, type: formValue.type, details: formValue.details}).then(handleClose)
    }

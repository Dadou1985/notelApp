                            ...
                            <Table striped bordered hover size="sm" className="text-center">
                                ...
                                <tbody>
                                    {info.map(flow =>(
                                        ...
                                        <td className="bg-dark"><Button variant="outline-danger" size="sm" onClick={()=>d.deleteDocument({documentId: user.displayName, collection: "cab", document: flow.id})}>Supprimer</Button></td>
                                    </tr>
                                    ))}
                                </tbody>
                            </Table>

    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        return db.addMaintenance({
            ...
            author: user.displayName, room: formValue.room, client: formValue.client, markup: marker, date: time, type: formValue.type, details: formValue.details}).then(handleClose)
    }

                            ...
                            <Table striped bordered hover size="sm" className="text-center">
                                ...
                                <tbody>
                                    {info.map(flow =>(
                                        ...
                                        <td>{flow.shift}</td>
                                        <td>{flow.date}</td>
                                        <td className="bg-dark"><Button variant="outline-danger" size="sm" onClick={()=>db.deleteDocument({hotelId: userDB.ho, collection: "safe", document: flow.id})}>Supprimer</Button></td>
                                        </tr>
                                    ))}
                                </tbody>
                            </Table>

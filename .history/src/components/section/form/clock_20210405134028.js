...
const Clock = () =>{
    ...
    useEffect(() => {
        ...
        db.toolOnAir({documentId: user.displayName, region: userDB.hotelRegion, departement: userDB.hotelDept,signal : signal, collection: "clock"}).onSnapshot(function(snapshot) {
                    const snapInfo = []

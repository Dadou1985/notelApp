...
const FeedbackBox = () =>{
    ...
    const handleChange = (event) =>{
      ...
      const handleSubmitFeedback = async(event) => {
        ...
        await db.addFeedback({author: user.displayName, 
        ...
        return db.addNotification({hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, notification: notif})
        .then(handleClose)
    }

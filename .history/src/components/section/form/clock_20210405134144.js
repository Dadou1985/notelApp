                        ...
                        <Table striped bordered hover size="sm" className="text-center">
                            ...
                            <tbody>
                                {info.map(flow =>(
                                    ...
                                    <td>{flow.date}</td>
                                    <td>{flow.author}</td>
                                    <td className="bg-dark"><Button variant="outline-danger" size="sm" onClick={()=>db.deleteDocument({documentId: user.displayName, collection: "clock", document: flow.id})}>Supprimer</Button></td>
                                    </tr>
                                ))}
                            </tbody>
                        </Table>

                ...
                <Row>
                    ...
                    <Tab.Content>
                        <Tab.Panel eventKey="Serviette">
                            {!!firebase && !!user && 
                            <CheckListTable shift="towel" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Savon">
                        {!!firebase && !!user && 
                            <CheckListTable shift="soap" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Papier Toilette">
                        {!!firebase && !!user && 
                            <CheckListTable shift="toilet-paper" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Sèche-cheveux">
                            {!!firebase && !!user && 
                            <CheckListTable shift="hair-dryer" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Coussin">
                        {!!firebase && !!user && 
                            <CheckListTable shift="pillow" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Couverture">
                        {!!firebase && !!user && 
                            <CheckListTable shift="blanket" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Fer à repasser">
                            {!!firebase && !!user && 
                            <CheckListTable shift="iron" firebase={firebase} user={user} />}
                        </Tab.Panel>
                        <Tab.Panel eventKey="Lit Bébé">
                        {!!firebase && !!user && 
                            <CheckListTable shift="baby-bed" firebase={firebase} user={user} />}
                        </Tab.Panel>
                    </Tab.Content>
                    </Col>
                </Row>

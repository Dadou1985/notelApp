...
const Cab = () =>{
    ...
    const handleSubmit = event => {
        ...
        setFormValue("")
        let marker = Date.now()
        db.addCab({hotelId: userDB., author: user.username, room: formValue.room, client: formValue.client, markup: marker, date: formValue.date, hour: formValue.hour, destination: formValue.destination, pax: formValue.passenger, model: formValue.model}).then(handleClose)
    }

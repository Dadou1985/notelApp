    ...
    const handleChange = (event) =>{
      ...
      const handleSubmit = event => {
        ...
        return db.addSafe({
            ...
            region: userDB.hotelRegion, departement: userDB.hotelDept, author: user.displayName, amount: caisse, date: time, markup: marker, shift: formValue.shift}).then(handleClose)
    }

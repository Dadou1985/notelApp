...
const Clock = () =>{
    ...
    const handleSubmit = event => {
        ...
        return db.addClock({
            ...
            region: userDB.hotelRegion, departement: userDB.hotelDept, author: user.displayName, room: formValue.room, day: formValue.date, client: formValue.client, markup: marker, date: time, hour: formValue.hour}).then(handleClose)
    }

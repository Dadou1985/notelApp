...
const Annuaire = () =>{
    ...
    return db.addContact({
        hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, name: formValue.name, mobile: formValue.mobile, fix: formValue.fix, markup: marker}).then(handleClose)
    }

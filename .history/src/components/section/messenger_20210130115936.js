                        ...
                        <List component="nav" aria-label="main mailbox folders" style={{
                            ...
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={BlueCircle} alt="urgent" style={{width: "25%", cursor: "pointer", marginRight: "1vw"}} onClick={() => {
                                        setStatus('')
                                        setChecked(false)}} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            ...
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={YellowCircle} alt="urgent" style={{width: "25%", cursor: "pointer", marginRight: "1vw"}} onClick={() => {
                                        setStatus('important')
                                        setChecked(false)}} />
                                </OverlayTrigger>
                                </ListItemIcon>

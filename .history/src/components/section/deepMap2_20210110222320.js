                                ...
                                <Divider style={{height: "1vh", marginBottom: "4vh"}} />
                                    ...
                                    marginTop: "4vh"
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{commentData.filter(rate === rate.team).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>commentData.filter(rate === rate.management).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{commentData.filter(rate === rate.customer).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{commentData.filter(rate === rate.wage).reduce(reducer)}</p>
                                        </div>
                                    </div>
                                </div>                                

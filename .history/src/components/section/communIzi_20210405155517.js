...
export default function CommunIzi() {
  ...
  const handleHideDrawer = () => {
    ...
    const handleSubmit = (event) =>{
        ...
        return db.addMessageIziChat({
          hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, roomName: expanded, author: user.displayName, text: note, mood: mood, hour: time, userId: user.uid, date: date})
    }

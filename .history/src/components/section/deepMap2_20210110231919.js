                            ...
                            defaultChecked={details}>
                                <div style={{
                                    ...
                                    <div style={{diplay: "flex", flexFlow: "row"}}>
                                        ...
                                        <img src={Arrow} alt="arrow" style={{width: "1vw", cursor: "pointer", marginLeft: "1vw", transform: "rotate(0.5turn)"}} id="arrowTop" onClick={handleShowDetails} />
                                    </div>
                                ...
                                <Divider style={{height: "1vh", marginBottom: "4vh"}} />
                                    ...
                                    marginTop: "4vh"
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{teamRate.length > 0 ? teamRate.reduce(reducer)/teamRate.length : "No Rate"}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{managementRate.length > 0 ? managementRate.reduce(reducer)/managementRate.length : "No rate"}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{customerRate.length > 0 ? customerRate.reduce(reducer)/customerRate.length : "No rate"}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{wageRate.length > 0 ? wageRate.reduce(reducer)/wageRate.length : "No rate"}</p>
                                        </div>
                                    </div>
                                </div>                                

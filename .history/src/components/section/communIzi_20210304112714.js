        ...
        <div className="communizi-container">
            ...
            <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
              <div id="drawer-container" style={{
                  ...
                  padding: "5%", 
                  maxHeight: "30vh"}}>
                  <div><Input type="text" placeholder="Donnez un nom la conversation" value={room} style={{borderTop: "none", borderLeft: "none", borderRight: "none", marginBottom: "3vh"}} maxLength="60" onChange={handleChangeRoomName} /></div>
                  <div style={{float: "right"}}><Button variant="success" style={{width: "100%"}} onClick={handleRoomnameSubmit}>Créer</Button></div>
              </div>
            </Drawer>
        </div>
    )

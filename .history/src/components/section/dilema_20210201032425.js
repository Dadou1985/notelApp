                    ...
                    <Tabs defaultActiveKey="Créer" id="uncontrolled-tab-example">
                            <Tab eventKey="Créer" title="Créer un espace de travail">
                                <div  style={{
                                    ...
                                    textAlign: "center"
                                        ...
                                        <Input type="text" placeholder="Donner un nom à votre espace de travail..." style={{width: "25vw", display: "flex",
                                        flexFlow: "row",
                                        alignItems: "center",
                                        justifyContent: "space-around",
                                        width: "100%"}} value={createRefSpace} name="createRefSpace" onChange={handleChangeCreate} />
                            ...
                            <div  style={{
                                    ...
                                    textAlign: "center"
                                        ...
                                        <Input type="text" placeholder="Entrer le nom de votre espace de travail" style={{width: "20vw", display: "flex",
                                    flexFlow: "column",
                                    justifyContent: "space-around",
                                    alignItems: "center",
                                    padding: "5%",
                                    textAlign: "center"}} value={joinRefSpace} name="joinRefSpace" onChange={handleChangeJoin} />
                                    </Form.Row>

    ...
    useEffect(() => {
     ...
     useEffect(() => {
        ...
        for(let i = 0; i < info.length; i++){
            firebase.hotelRatingDataOnAir({region: region, departement: departement, hotelId: info[i].id, signal : signal}).onSnapshot(function(snapshot) {
                const snapInfo = []
              snapshot.forEach(function(doc) {          
                snapInfo.push({
                    id: doc.id,
                ...
                console.log(snapInfo)
                return setCommentData(snapInfo)
            });
        }
                     ...
                     <OverlayTrigger
                        ...
                        <Tooltip id="title">
                            ...
                            <Box component="fieldset" mb={3} borderColor="transparent">
                                ...
                                <Rating
                                name="management"
                                value={commentData === [] ? 0 : commentData[0].wage}
                                precision={0.5}

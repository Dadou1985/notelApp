...
const CheckListTable = ({shift}) => {
    ...
    useEffect(() => {
        let unsuistOnAir({hotelId: userDB.hotelId, region: userDB.hotelRegion, departement: userDB.hotelDept, collection: shift, signal : signal}).onSnapshot(function(snapshot) {
                    const snapInfo = []

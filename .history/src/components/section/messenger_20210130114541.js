                        ...
                        <List component="nav" aria-label="main mailbox folders" style={{
                            ...
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={BlueCircle} alt="urgent" style={{width: "25%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setStatus('')} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={YellowCircle} alt="urgent" style={{width: "25%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setStatus('important')} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={RedCircle} alt="urgent" style={{width: "25%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setStatus('urgent')} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                        </List>

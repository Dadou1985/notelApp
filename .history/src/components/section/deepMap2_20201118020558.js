                            ...
                            <Modal show={list}
                                        ...
                                        <div>
                                            ...
                                            <Form.Row>
                                                <Form.Group controlId="description" style={{width: "100%"}}>
                                                    ...
                                                    <Form.Control as="textarea" type="text" size="sm" style={{width: "100%", resize: "none"}} value={formValue.bestOf} name="hotelName" onChange={handleChange} />
                                                </Form.Group>
                                            </Form.Row>
                                            <Form.Row>
                                                <Form.Group controlId="description" style={{width: "100%"}}>
                                ...
                                onClick={(event) => {
                                    ...
                                    firebase.addCommentOnHotel({
                                        hotelId: selectedHotel.telephone, 

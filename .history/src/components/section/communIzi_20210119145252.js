...
export default function CommunIzi({firebase, user}) {
    ...
    const userMood = [
        {name: "Feel Good", value: "happy"},
        {name: "A deux doigts 2 tout brûler", value: "angry"},
        {name: "J-1 avant la dépression nerveuse", value}
    ]
    ...
    return (
        <div style={{width: "90%"}}>
            ...
            <div>
                ...
                <ListBox value={mood} options={userMood} onChange={(e) => setMood(e.value)} optionLabel="name" style={{width: '15rem'}} />
                </Form>
            </div>
        </div>
    )

...
const Navigation = () =>{
    ...
    return(
        <div className="shadow-lg bg-white" style={{filter: "drop-shadow(1px 1px 10px)"}}>
            <Navbar bg="light" expand="lg" style={{
                ...
                <Navbar.Brand className="brand"
                    ...
                    <img src={Fom} alt="Fom" style={{width: "7%", marginLeft: "1vw", marginRight: "1vw", filter: "drop-shadow(1px 1px 1px)"}} onClick={()=>navigate('/yinYanPage')} />
                    </OverlayTrigger>
                    {!!user && !!user.email &&

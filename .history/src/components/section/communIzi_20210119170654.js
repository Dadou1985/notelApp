            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <div style={{
                        ...
                        width: "15%"}}>
                        <img src={AngryBear} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} />
                        <img src={Send} alt="sendIcon" style={{width: "40%", cursor: "pointer"}} onClick={handleSubmit} />          
                    </div>
                        <Dropdown value={mood} options={countries} onChange={onCountryChange} optionLabel="name" filter showClear filterBy="name" placeholder="Select a Country"

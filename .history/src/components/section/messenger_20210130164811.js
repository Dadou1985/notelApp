...
const Messenger = () =>{
    ...
    const renderSwitch = (status) => {
        ...
        default:
            ...
            overlay={
             ...
             <img src={Circle} alt="default" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
        </OverlayTrigger>
        }
      }
    ...
    const handleSubmit = (event) =>{
        ...
        firebase.addNote({documentId: user.displayName, noteId: title, author: user.username, text: note, status: status, hour: time, markup: marker, userId: user.uid, date: date})
        setShowModal(false)
    }
    ...
    return(
        <div className="messenger_container">
            ...
            centered>
                ...
                <Modal.Title id="example-modal-sizes-title-sm" style={{width: "100%"}} style={{backgroundColor: "lightgrey"}}>
                    <Input type="text" name="title" placeholder="Donner un titre à la note..." style={{border: "none", width: "100%", color: "black", fontWeight: "100"}} maxLength="60" onChange={handleChangeTitle} required />
                </Modal.Title>
                </Modal.Header>
                <Modal.Body>

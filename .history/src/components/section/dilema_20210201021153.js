...
import { Form, Button, Table, Tabs, Tab, Input, OverlayTrigger, Modal } from 'react-bootstrap'
...
const Dilema = () => {
    ...
    const [createRefSpace, setCreateRefSpace] = useState(sha224("test"))
                    ...
                    <Tabs defaultActiveKey="Créer" id="uncontrolled-tab-example">
                            <Tab eventKey="Créer" title="Créer un espace de travail">
                                <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Control type="text" placeholder="Donner un nom à votre espace de travail..." style={{width: "25vw"}} value={createRefSpace} name="createRefSpace" onChange={handleChangeCreate} />
                                        </Form.Group>
                                    </Form.Row>
                            ...
                            <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Group controlId="description">
                                        <Form.Control type="text" placeholder="Entrer le nom de votre espace de travail" style={{width: "20vw"}} value={joinRefSpace} name="joinRefSpace" onChange={handleChangeJoin} />
                                        </Form.Group>
                                    </Form.Row>

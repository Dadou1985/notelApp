    ...
    return (
        <div style={{
            ...
            <Form.Row>
                ...
                <select class="selectpicker" value={formValue.job} name="model" onChange={handleChange} 
                style={{width: "20vw", 
                height: "6vh", 
            ...
            <Form.Row>
                <Form.Group controlId="description">
                <Form.Label>Type de véhicule</Form.Label><br/>
                <select class="selectpicker" value={formValue.level} name="model" onChange={handleChange} 
                style={{width: "20vw", 
                height: "6vh", 
                border: "1px solid lightgrey", 
                borderRadius: "3px",

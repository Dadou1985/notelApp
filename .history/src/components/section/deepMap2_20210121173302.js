...
export default function DeepMap2({user, firebase}) {
    ...
    const [region, setRegion] = useState("Choisir une région")
    ...
    return (
        ...
        overflow: "hidden"}}>
            ...
            {<div style={{
                ...
                <DropdownButton id="dropdown-basic-button" title={initialFilter === "classement" ? filter : "Classement"} variant='warning'>

                ...
                {selectedHotel ? (
                    <>
                        <ToggleDisplay show={details}>
                            ...
                            <ToggleDisplay show={show}>
                                ...
                                <div style={{display: "flex", flexFlow: "column", justifyContent: "center", marginBottom: "5vh"}}>
                                    ...
                                    <div style={{
                                        ...
                                        justifyContent: "space-between",
                                        alignItems: "center"}}>
                                        <Button size="lg" style={{width: "78%"}} variant="default" onClick={handleShow}>Ajouter un avis</Button>
                                        <span>
                            ...
                            <DropdownButton id="dropdown-basic-button" title={departement} variant='info'  drop="right">
                            ...
                            <DropdownButton id="dropdown-basic-button" title={initialFilter === "classement" ? filter[0] : "Classement"} variant='warning' drop="right">

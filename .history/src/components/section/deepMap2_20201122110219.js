    ...
    return (
        ...
        flexFlow: "row"}}>
            ...
            <div style={{
                ...
                <DropdownButton id="dropdown-basic-button" title="Choisir une région" drop>
                {RegionDetails.map(details => (
                    <Dropdown.Item  onClick={()=>{
                        console.log(details.view)
                        setZoom(details.view)
                        handleDepartement(details.nom, details.coordinates[0], details.coordinates[1])}}>{details.region}</Dropdown.Item>
                    ))}
                </DropdownButton>
                </Form.Group>

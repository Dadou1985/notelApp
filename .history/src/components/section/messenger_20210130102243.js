...
const Messenger = () =>{
    ...
    const renderSwitch = (status) => {
        switch(status) {
          case 'important':
            return <img src={YellowCircle} alt="important" style={{width: "30%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
          case 'urgent':
            return <img src={RedCircle} alt="urgent" style={{width: "25%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
          default:
            return <img src={BlueCircle} alt="info" style={{width: "30%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
        }
      }

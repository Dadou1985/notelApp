    ...
    return (
        info.map(flow =>(
            <div style={{
                ...
                <div style={{backgroundColor: "rgb(33, 35, 39)", width: "100%", height: "40%", marginBottom: "1%", borderTopLeftRadius: "15px", borderTopRightRadius: "15px"}}>
                    <AvatarUi
                    style={{width: "5vw", height: "10vh", backgroundColor: "'#'+(Math.random()*0xFFFFFF<<0).toString(16)", marginBottom: "2vh"}}
                    />
                    {/*<Avatar 
                ...
                <div style={{
                    ...
                    flexFlow: "column",
                    alignItems: "center",
                    backgroundColor: "rgb(33, 35, 39)",  width: "100%", height: "45%", marginBottom: "1%"
                }}>
                    <h2 style={{filter: "drop-shadow(1px 1px 1px)", marginTop: "1vh", marginBottom: "2vh"}}>{flow.id}</h2>
                    <p><b>{flow.hotelName}</b></p>
                    <p><b>Casquette: </b>{flow.job}</p>
                    <p><b>Level: </b>{flow.category}</p>
                </div>
                
                <div style={{backgroundColor: "rgb(33, 35, 39)",  width: "100%", height: "13%", marginBottom: "1%", borderBottomLeftRadius: "15px", borderBottomRightRadius: "15px"}}> 

    ...
    <div className="karenStory-global-container">
        <span className="karenStory-header-container"> 
            ...
            <Avatar 
                round={true}
                name={author}
                size={typeof window && window.innerWidth > 480 ? "50" : "30"}
        ...
        <span className="tips-container">
            <span>
                <img src={Tips} style={{width: "7%", marginRight: "1vw", cursor: "pointer"}} id="coin" />
                <span id="tipsCount"> tips</span>
            </span>
        </span>
        <div className="karenStory-comment-container">
            <Input 
                placeholder="Ecrire un commentaire..." 
                onChange={handleChange}
                value={comment} />
            <img src={Comment} alt="comment" style={{width: "7%", cursor: "pointer", filter: "invert(100%)"}} onClick={handleSubmit} />
        </div>
        <Divider style={{height: "1vh"}} />
        <div className="karenStory-comment-box">
            <span>{details.length} commentaires</span>
            <img src={Arrow} alt="arrow" style={{width: "vw", cursor: "pointer", filter: "invert(100%)"}} id="arrow" onClick={handleShow} />
        </div>

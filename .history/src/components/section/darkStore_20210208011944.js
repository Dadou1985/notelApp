            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p>Le logicie FOLS développé par le groupe hôtelier ACCOR est probablement le PMS le plus abouti sur le marché des outils de gestion des activités hôtelière.<br/>
                        Son interface sophistiquée et sa prise en main intuitive 
                        </p>
                    </div>
                </div>
                <div style={{

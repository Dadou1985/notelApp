                    ...
                    <>
                        <ToggleDisplay show={details}>
                            <div className="toggleDisplay-global-container">
                                ...
                                <div className="toggleDisplay-header-container">
                                    <div className="toggleDisplay-header-text">
                                        ...
                                        <span>Etablissement {selectedHotel.classement[0]}<img src={Arrow} alt="arrow" style={{width: "15px", cursor: "pointer", marginLeft: "vw", transform: "rotate(0turn)"}} id="arrowTop" onClick={handleShowDetails} /></span>
                                    </div>
                            ...
                            <ToggleDisplay show={show}>
                                ...
                                <Divider style={{height: "1vh", marginBottom: "5vh"}} />
                                    ...
                                    <div className="toggleDisplay-body-stats-container">
                                        <div className="toggleDisplay-body-stats-box">
                                            ...
                                            <p style={{ontSize: "1em"}}>{teamRate.length > 0 ? <Box component="fieldset" mb={3} borderColor="transparent">
                                                    <Typography component="legend"></Typography>
                                                    <Rating
                                                    name="team"
                                        ...
                                        <div className="toggleDisplay-body-stats-box">
                                            ...
                                            <p style={{fontSize: "1em"}}>{managementRate.length > 0 ? <Box component="fieldset" mb={3} borderColor="transparent">
                                            <Typography component="legend"></Typography>
                                                    <Rating
                                                    name="team"
                                        ...
                                        <div className="toggleDisplay-body-stats-box">
                                            ...
                                            <p style={{fontSize: "1em"}}>{customerRate.length > 0 ? <Box component="fieldset" mb={3} borderColor="transparent">
                                            <Typography component="legend"></Typography>
                                                    <Rating
                                                    name="team"
                                        ...
                                        <div className="toggleDisplay-body-stats-box">
                                            ...
                                            <p style={{fontSize: "1em"}}>{wageRate.length > 0 ? <Box component="fieldset" mb={3} borderColor="transparent">
                                            <Typography component="legend"></Typography>
                                                    <Rating
                                                    name="team"
                                ...
                                <div style={{display: "flex", flexFlow: "column", justifyContent: "center", marginBottom: "5vh", width: "100%"}}>
                                    <Divider style={{height: "1vh", marginBottom: "5vh"}} />
                                    <div style={{
                                        display: "flex",
                                        flexFlow: "row",
                                        ...
                                        alignItems: "center"}}>
                                        <Button size="lg" style={{width: "78%"}} variant="secondary" onClick={handleShow}>Noter cet hôtel</Button>
                                        <span>
                            ...
                            {details ? <></> :
                                ...
                                <DropdownButton id="dropdown-basic-button" title={region} drop="right">
                                ...
                                {region !== "Région" ? <DropdownButton id="dropdown-basic-button" title={departement} variant='info'  drop="right">
                                ...
                                {departement !== "Département" ? <DropdownButton id="dropdown-basic-button" title={initialFilter === "classement" ? filter[0] : "Classement"} variant='warning' drop="right">

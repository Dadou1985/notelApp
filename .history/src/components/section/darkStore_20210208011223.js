            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <p>Le logicie FOLS développé par le groupe hôtelier ACCOR est probablement le PMS le plus abouti sur le marché des outils de gestion de la réservation.</p>
                    </div>
                </div>
                <div style={{
                    display: "flex",

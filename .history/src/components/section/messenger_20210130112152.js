...
import Grow from '@material-ui/core/Fab';
                        ...
                        <List component="nav" aria-label="main mailbox folders" style={{
                            ...
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={RedCircle} alt="urgent" style={{width: "20%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={YellowCircle} alt="urgent" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                            <ListItemIcon button>
                                ...
                                <OverlayTrigger
                                    ...
                                    <img src={BlueCircle} alt="urgent" style={{width: "5%", cursor: "pointer", marginRight: "1vw"}} onClick={() => setChecked(true)} />
                                </OverlayTrigger>
                                </ListItemIcon>
                            </ListItemIcon>
                        </List>

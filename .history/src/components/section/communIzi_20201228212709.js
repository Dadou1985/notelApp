    ...
    return (
        <div style={{width: "90%"}}>
            ...
            <div>
                ...
                <img src={Send} alt="sendIcon" style={{width: "3vw", borderRadius: "25%"}} />
                <div className="communizi_form_footer">
                    <Button color="primary" block id="communizi_noteButton">Noter</Button>
                </div>
                </Form>
            </div>
        </div>

            ...
            <div className="communizi_notebox">
                {info.map((flow) => (
                      ...
                      <AccordionSummary aria-controls={flow.id} id={flow.id}>
                        <div syyle={{display: "flex", flexFlow: "row", justifyContent: "space-between", width: "100%"}}>
                        <Typography style={{width: "50%"}}>{flow.id}</Typography>
                        <Typography style={{width: "50%"}}>{flow.user}</Typography>
                        </div>
                      </AccordionSummary>
                      <AccordionDetails>

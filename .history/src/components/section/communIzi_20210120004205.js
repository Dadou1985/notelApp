                    ...
                    <div style={{
                        ...
                        width: "15%"}}>
                            <div style={{
                                ...
                                <ul style={{position: "absolute", zIndex: "6"}}>
                                    <li><img src={AngryBear} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                    <li><img src={Smile} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                    <li><img src={Scared} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                    <li><img src={LowBattery} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                    <li><img src={Emergency} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                    <li><img src={Chill} alt="angry" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} /></li>
                                </ul>
                                {renderSwitch(mood)}
                            </div>

    ...
    return(
        <div className="messenger_container">
            ...
            <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                <div>
                    <div><Input type="text" name="title" placeholder="Donner un titre à la note..." style={{backgroundColor: "lightblue", width: "100%", color: "black", fontWeight: "100", backgroundColor: "transparent"}} maxLength="60" onChange={handleChangeTitle} required /></div>

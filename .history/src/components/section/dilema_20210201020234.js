                    ...
                    <Tabs defaultActiveKey="Créer" id="uncontrolled-tab-example">
                            ...
                            <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Control type="text" placeholder="Entrer le nom de votre espace de travail" style={{width: "20vw"}} value={joinRefSpace} name="joinRefSpace" onChange={handleChangeJoin} />                                    </Form.Row>

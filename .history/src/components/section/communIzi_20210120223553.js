    ...
    return (
        <div style={{width: "90%"}}>
            ...
            centered>
                ...
                <Modal.Body>
                    <Input type= placeholder="nom de la conversation" value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none"}} maxLength="100" onChange={handleChangeRoomName} />
                </Modal.Body>

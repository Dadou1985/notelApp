                        ...
                        <ToggleDisplay show={details}>
                            ...
                            <Modal show={list}
                                        ...
                                        <div>
                                            <Form.Row>
                                                <Form.Group controlId="description" style={{width: "100%"}}>
                                                    ...
                                                    <Form.Control type="text" size="sm" style={{width: "100%"}} value={formValue.hotelName} name="hotelName" onChange={handleChange} />
                                                </Form.Group>
                                            </Form.Row>
                                            <Form.Row>
                                            ...
                                            <Form.Row>
                                                <Form.Group controlId="description" style={{width: "100%"}}>
                                                    ...
                                                    <Form.Control as="textarea" type="text" size="sm" style={{width: "100%", resize: "none"}} value={formValue.hotelName} name="hotelName" onChange={handleChange} />
                                                </Form.Group>
                                            </Form.Row>
                                            <Form.Row>
                                                <Form.Group controlId="description" style={{width: "100%"}}>
                                ...
                                onClick={(event) => {
                                    event.preventDefault()
                                    setformValue("")
                                    firebase.addCommentOnHotel({hotelId: selectedHotel.telephone, commentTitle: formValue.commentTitle})

...
const Dilema = ({user, firebase}) => {
    ...
    const firstStep = () => {
        return <Tabs defaultActiveKey="Créer" id="uncontrolled-tab-example">
    ...
    return (
        ...
        <Dialog showDialog={showDialog}>
            <div style={{
                ...
                <div style={{
                    borderBottom: "1px solid lightgrey", height: "50vh"}}>
                    <h4>Créer un espace de travail</h4>
                ...
                <div style={{borderBottom: "1px solid lightgrey", height: "50vh"}}>
                    <h4>Rejoindre un espace de travail</h4>
                    <div className="dialog-tab-container">
                        <Form.Row className="join-space-form">
                            <Input type="text" placeholder="Entrer le nom de votre espace de travail" className="join-space-input" value={joinRefSpace} name="joinRefSpace" onChange={handleChangeJoin} />
                        </Form.Row>

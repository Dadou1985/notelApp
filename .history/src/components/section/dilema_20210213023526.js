                ...
                <div style={{
                    ...
                    <h1 style={{fontSize: "5em", marginBottom: "5vh", marginLeft: "3vw"}}>
                        ...
                        <div style={{
                            ...
                            alignItems: "center",
                            marginLeft: "1vw", 
                            fontSize: "20px"}}><img src={Tips} alt="tips" style={{width: "2vw"}} /> 50 tips <img src={Arrow} alt="arrow" style={{width: "1vw", cursor: "pointer", marginLeft: "1vw", transform: "rotate(0turn)"}} id="arrowTop" onClick={handleShowDetails} /> </div>
                    </h1>
                    <ToggleDisplay show={showD}>
                        <div style={{
                            display: "flex",

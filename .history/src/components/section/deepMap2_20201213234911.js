                    ...
                    > 
                     <OverlayTrigger
                        ...
                        <Tooltip id="title" onMouseOver={()=>{setHotelRef(hotel.id)}} onMouseLeave={()=>{setHotelRef(null)}}>
                            ...
                            {commentData !== [] ? <Box component="fieldset" mb={3} borderColor="transparent">
                                ...
                                readOnly
                                />
                            </Box> : <div style={{backgroundColor: "red"}}>No score !</div> }
                            <div style={{backgroundColor: "red"}}>No score !</div> 
                        </Tooltip>
                        }>

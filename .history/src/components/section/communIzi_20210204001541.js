            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <div style={{
                        ...
                        <img src={Plus} alt="plus" style={{width: "25%", cursor: "pointer"}} onClick={handleShow} />          
                    </OverlayTrigger>
                    <OverlayTrigger
                        placement="top"
                        overlay={
                    ...
                    <ul style={{position: "relative", zIndex: "6", listStyleType: "none", left: "425px", bottom: "300px"}} id="moodList" className="moodList">
                        <li onClick={() => {
                          setMood("angry")

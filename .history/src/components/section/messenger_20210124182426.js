...
const Messenger = () =>{
    ...
    return(
        <div className="messenger_container">
            ...
            />
            <img src={Calendar} alt="sendIcon" style={{width: "4%", cursor: "pointer"}} onClick={handleSubmit} />
            <img src={Send} alt="sendIcon" style={{width: "4%", cursor: "pointer", borderRadius: "50%"}} onClick={handleSubmit} />

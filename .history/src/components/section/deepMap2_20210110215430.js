                                ...
                                {ratingData && ratingData.map(rate => (
                                    ...
                                    marginTop: "4vh"
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{rate.team.length > 1 ? rate.team.reduce(function(accumulateur, valeurCourante){
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{rate.management.length > 1 ? rate.management.reduce(function(accumulateur, valeurCourante){
                                                return accumulateur + valeurCourante;
                                            }) : rate.management}</p>
                                        </div>
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{rate.customer.length > 1 ? rate.customer.reduce(function(accumulateur, valeurCourante){
                                                return accumulateur + valeurCourante;
                                            }) : rate.customer}</p>
                                        </div>
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{rate.wage.length > 1 ? rate.management.reduce(function(accumulateur, valeurCourante){
                                                return accumulateur + valeurCourante;
                                            }) : rate.management}</p>
                                        </div>
                                    </div>

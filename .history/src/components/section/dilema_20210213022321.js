...
const Dilema = ({user, firebase}) => {
    ...
    return (
        <div style={{
                ...
                <div style={{
                    ...
                    <h1 style={{fontSize: "5em", marginBottom: "5vh", marginLeft: "3vw"}}>
                        ...
                        <div style={{
                            ...
                            alignItems: "center",
                            marginLeft: "1vw", 
                            fontSize: "20px"}}><img src={Tips} alt="tips" style={{width: "2vw"}} /> 50 tips </div>
                    </h1>
                    <div style={{
                        display: "flex",
            ...
            <h2 style={{color: "lightgrey", filter: "drop-shadow(-1px 1px 1px)", marginTop: "3"}}>Choisissez votre espace</h2>
        </div>

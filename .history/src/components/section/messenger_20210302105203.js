        ...
        <div className="messenger_container">
            ...
            <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
                <div>
                    ...
                    <div><Input type="text" placeholder="Rédiger une note..." value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none", height: "10vh", minHeight: "5vh", maxHeight: "15vh"}} onChange={handleChangeNote} required />
</div>
                </div>
            </Drawer>

        ...
        <div className="communizi-container">
            ...
            <Drawer anchor="bottom" open={activate} onClose={handleHideDrawer}>
              <div id="drawer-container" style={{
                  ...
                  padding: "5%", 
                  maxHeight: "30vh"}}>
                  <div><Input type="text" placeholder="Donnez un nom la conversation" value={room} style={{borderTop: "none", borderLeft: "none", borderRight: "none", }} maxLength="60" onChange={handleChangeRoomName} /></div>

        ...
        flexFlow: "row"}}>
            ...
            <div style={{
                ...
                <DropdownButton id="dropdown-basic-button" title="Départements" variant='info'>
                    ...
                    <Dropdown.Item onClick={()=>{handleStars("2 étoile")}}>2 étoiles</Dropdown.Item>
                    <Dropdown.Item onClick={()=>{handleStars("1 étoile")}}>3 étoiles</Dropdown.Item>
                    <Dropdown.Item onClick={()=>{handleStars("1 étoile")}}>4 étoiles</Dropdown.Item>
                    <Dropdown.Item onClick={()=>{handleStars("1 étoile")}}>5 étoiles</Dropdown.Item>
                </DropdownButton>
                </Form.Group>
                </Form.Row>
                <Form.Group style={{

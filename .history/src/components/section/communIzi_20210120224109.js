...
export default function CommunIzi({firebase, user}) {
    ...
    const renderSwitch = (mood) => {
        switch(mood) {
          case 'angry':
            return <img src={AngryBear} alt="angry" style={{width: "40%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
          case 'happy':
          ...
          default:
            return <img src={Chill} alt="chill" style={{width: "35%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
        }
      }

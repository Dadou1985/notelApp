                ...
                {selectedHotel ? (
                    <>
                        <ToggleDisplay show={details}>
                            ...
                            {region === "region" ? <DropdownButton id="dropdown-basic-button" title={departement} variant='info'  drop="right">
                            ...
                            {Reg<DropdownButton id="dropdown-basic-button" title={initialFilter === "classement" ? filter[0] : "Classement"} variant='warning' drop="right">

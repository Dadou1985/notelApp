...
export default function CommunIzi({firebase, user}) {
    ...
    const renderSwitch = (mood) => {
        switch(mood) {
          ...
          case 'happy':
            return <img src={Smile} alt="happy" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} />
          case 'scared':
            return <img src={Scared} alt="scared" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} />
          case 'depressed':
            return <img src={LowBattery} alt="depressed" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} />
          case 'emergency':
            return <img src={Emergency} alt="emergency" style={{width: "50%", borderRadius: "50px", cursor: "pointer"}} />
          default:
            return <img src={Chill} alt="chill" style={{width: "55%", borderRadius: "50px", cursor: "pointer"}} />
        }
      }
        ...
        <div style={{width: "90%"}}>
            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <ul style={{position: "absolute", zIndex: "6", listStyleType: "none", bottom: "15%", left: "28vw"}} id="moodList" className="">
                        <li onClick={() => setMood("angry")}><img src={AngryBear} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick={() => setMood("happy")}><img src={Smile} alt="smile" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick={() => setMood("scared")}><img src={Scared} alt="scared" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick={() => setMood("depressed")}><img src={LowBattery} alt="lowBattery" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick={() => setMood("emergency")}><img src={Emergency} alt="emergency" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li onClick={() => setMood("")}><img src={Chill} alt="chill" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                    </ul>
                </Form>
            </div>
        </div>

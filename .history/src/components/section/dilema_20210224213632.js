        ...
        style={{ backgroundImage: `url(${"https://i.pinimg.com/originals/cb/59/ff/cb59ffb54f7bcca4dbbc1517a65c1f01.jpg"})` }}>
                <div className="profile-container">
                    <h1>
                        <b>{flow.id}</b>
                        <div>
                            <img src={Tips} alt="tips" style={{width: "2vw"}} /> 
                            {flow.tips} tips <img src={Arrow} alt="arrow" style={{width: "1vw", cursor: "pointer", marginLeft: "1vw", transform: "rotate(0turn)"}} id="arrowTop" onClick={handleShowDetails} /> 
                        </div>
                    </h1>

...
const Dilema = () => {
    ...
    const [formValue, setFormValue] = useState({email: "", password: "", userId: "", refSpace: "", username: ""})
    ...
    const handleCreateSpaceSubmit = () => {
        setFormValue({email: "", password: "", userId: "", refSpace: "", username: ""})
        firebase.adminWorkspaceRegister({email: formValue.email, password: formValue.password, userId: form})
    }

...
export default function DeepMap2({user, firebase}) {
    ...
    useEffect(() => {
     ...
     const teamRate = ratingData.filter(rate => rate.wage)
     const teamManagement = ratingData.filter(rate => rate.wage)
     const teamCustomer = ratingData.filter(rate => rate.wage)
     const teamWage = ratingData.filter(rate => rate.wage)
                                ...
                                <Divider style={{height: "1vh", marginBottom: "4vh"}} />
                                    ...
                                    marginTop: "4vh"
                                        ...
                                        <div style={{
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{ratingData.filter(rate => rate.team).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{ratingData.filter(rate => rate.management).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{ratingData.filter(rate => rate.customer).reduce(reducer)}</p>
                                        </div>
                                        <div style={{
                                            display: "flex",
                                            flexFlow: "column",
                                            ...
                                            <p style={{color: "green", fontSize: "2em"}}>{ratingData.filter(rate => rate.wage).reduce(reducer)}</p>
                                        </div>
                                    </div>
                                </div>                                

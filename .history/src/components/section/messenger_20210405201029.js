                ...
                const uploadTask = () => {
                    ...
                    if(moment(startDate).format('L') !== moment(new Date()).format('L')) {
                       ...
                       return setShowModal(false)
                        ...
                        addNote({documentId: user.displayName, noteId: title, author: user.username, text: note, img: url, status: status, hour: time, markup: marker, userId: user.uid, date: date})
                        handleHideDrawer()
                        setShowModal(false)
                    }

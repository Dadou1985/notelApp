    ...
    return (
      <span className="darkTextUser">
        ...
        <div className="darkTextBodyUser">
          ...
          <span style={{color: "gray", fontSize: "85%", textAlign: "right", filter: "drop-shado(1px 1px 1px)"}}><i>le {date} à {hour}</i></span>
        </div>
      </span>
    )
  }else{
    return (
      <span className="darkTextOther">
        ...
        <div className="darkTextBodyOther">
          <span style={{marginBottom: "2%"}}>{text}</span>
          <span style={{color: "black", fontSize: "85%", textAlign: "right"}}><i>le {date} à {hour}</i></span>
        </div>
      </span>
    )
  }

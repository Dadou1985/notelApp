        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <img src={Fols} alt="formation fols" style={{width: "15vw", borderRadius: "5px"}} />
                ...
                <div style={{
                    ...
                    <img src={Conciergerie} alt="My Concierge" style={{width: "15vw", borderRadius: "5px"}} />
                </div>
                <div style={{
                    display: "flex",
                    flexFlow: "column",
                    ...
                    <img src={Overbooking} alt="Overbooking" style={{width: "13vw", borderRadius: "5px"}} />
                </div>
            </div>
        </div>
    )

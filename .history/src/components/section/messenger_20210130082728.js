    ...
    return(
        <div className="messenger_container">
            ...
            <PerfectScrollbar>
                ...
                <img src={Plus} alt="Plus" style={{width: "1%", cursor: "pointer", marginRight: "1vw", position: "fixed", right: "45vw", zIndex: "5"}} onChange={handleShow} />
            </OverlayTrigger>
            </PerfectScrollbar>
            ...
            centered>
                ...
                <Modal.Body>
                    <Input type="text" placeholder="Donnez un nom la conversation" value={note} style={{borderTop: "none", borderLeft: "none", borderRight: "none"}} maxLength="60" onChange={handleChange} />
                </Modal.Body>

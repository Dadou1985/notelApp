...
export default function IziNews() {
    ...
    let request = "https://www.youtube.com/feeds/videos.xml?channel_id=UCtZoA9ADAefKjzI1ukT-cRA"

    let feeds = JSON.parse(request.responseText)
    setFeed(feeds.media:group)

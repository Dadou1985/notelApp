        ...
        <div style={{width: "90%"}}>
            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <ul style={{position: "absolute", zIndex: "6", listStyleType: "none", bottom: "15%", left: "28vw"}} id="mood">
                        <li><img src={AngryBear} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li><img src={Smile} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li><img src={Scared} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li><img src={LowBattery} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li><img src={Emergency} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                        <li><img src={Chill} alt="angry" style={{width: "5%", borderRadius: "50px", cursor: "pointer", marginBottom: "1vh"}} /></li>
                    </ul>
                </Form>
            </div>
        </div>

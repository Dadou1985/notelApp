...
const Dilema = () => {
    ...
    const handleChange = event =>{
        setRefSpace(event.currentTarget.value)
    }
                    ...
                    <Tabs defaultActiveKey="Créer" id="uncontrolled-tab-example">
                            <Tab eventKey="Créer" title="Créer un espace de travail">
                                <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Label><h2>Donner un nom à votre espace de travail</h2></Form.Label>
                                        <Form.Control type="text" placeholder="Mon espace de travail..." style={{width: "15vw"}} value={refSpace} name="refSpace" onChange={handleChange} />
                                        </Form.Group>
                                    </Form.Row>
                                    <Button variant="outline-success" onClick={handleCreateSpaceSubmit}>Enregistrer</Button>
                                </div>
                            </Tab>
                            ...
                            <div  style={{
                                    ...
                                    <Form.Row style={{
                                        ...
                                        <Form.Group controlId="description">
                                        <Form.Label>Entrer le nom de votre espace de travail</Form.Label>
                                        <Form.Control type="text" placeholder="ex: Jane Doe" style={{width: "10vw"}} value={refSpace} name="refSpace" onChange={handleChange} />
                                        </Form.Group>
                                    </Form.Row>
                                    <Button variant="outline-success" onClick={handleJoinSpaceSubmit}>Enregistrer</Button>
                                </div>
                            </Tab>
                        </Tabs>
                    </Modal.Body>

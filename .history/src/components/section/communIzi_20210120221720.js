    ...
    return (
        <div style={{width: "90%"}}>
            ...
            <div>
                ...
                <FormGroup  className="communizi_form_input_container"> 
                    ...
                    <div style={{
                        ...
                        <img src={Plus} alt="sendIcon" style={{width: "25%", cursor: "pointer"}} onClick={handleSubmit} />          
                    </OverlayTrigger>
                    <OverlayTrigger
                        placement="top"
                        overlay={
            ...
            <Modal show={showModal} onHide={handleClose}>
                ...
                <Modal.Body>
                    <Input placeholder="nom de la conversation" style={{borderTop: "none", borderLeft: "none", borderRight: "none"}} />
                </Modal.Body>
                <Modal.Footer style={{borderTop: "none"}}>
                    <Button variant="success">Quitter</Button>
                </Modal.Footer>
            </Modal>
        </div>
    )

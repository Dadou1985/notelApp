    ...
    return (
        <div style={{width: "90%"}}>
            ...
            centered>
                ...
                <Modal.Body>
                    <Input type="text" placeholder="Donneznom la conversation" value={room} style={{borderTop: "none", borderLeft: "none", borderRight: "none"}} maxLength="60" onChange={handleChangeRoomName} />
                </Modal.Body>

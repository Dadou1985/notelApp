            ...
            centered>
                ...
                <Modal.Footer style={{borderTop: "none"}}>
                    <div style={{
                        ...
                        />
                        {renderSwitch(status)}
                        <img src={Calendar} alt="sendIcon" style={{width: "5%", cursor: "pointer", filter: "drop-shadow"}} />
                        <img src={Send} alt="sendIcon" style={{width: "5%", cursor: "pointer", borderRadius: "50%", marginLeft: "2vw"}} onClick={handleSubmit} />

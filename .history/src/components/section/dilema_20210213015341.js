        ...
        <div style={{
            ...
            {info.map(flow => (
                <div style={{
                    ...
                    <h1 style={{fontSize: "5em", marginBottom: "5vh"}}><b>{flow.id}</b></h1>
                    <div style={{
                        display: "flex",
                        ...
                        <div>
                            hotel<p style={{fontSize: "2em"}}>{flow.hotelName}</p>
                        </div>
                        <div>
                            poste<p style={{fontSize: "2em">{flow.job}</p>
                        </div>
                        <div>
                            level<p style={{fontSize: "2em">{flow.category}</p>
                        </div>
                        <div>
                            tips<p style={{fontSize: "2em">5</p>
                        </div>
                    </div>
                </div>
            ))}

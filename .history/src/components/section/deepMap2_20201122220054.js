...
export default function DeepMap2({user, firebase}) {
    ...
    useEffect(() => {
        ...
        firebase.hotelDataOnAir({region: region, initialFilter: initialFilter, operator: operator filter: filter, signal : signal}).onSnapshot(function(snapshot) {
                    const snapInfo = []
     ...
     },[region, filter, initialFilter, operator])
    ...
    return (
        ...
        flexFlow: "row"}}>
            ...
            <div style={{
                ...
                <DropdownButton id="dropdown-basic-button" title="Départements" variant='info'>
                    <Dropdown.Item>Toutes les étoiles</Dropdown.Item>
                    <Dropdown.Item>1 étoile</Dropdown.Item>
                    <Dropdown.Item>2 étoiles</Dropdown.Item>
                    <Dropdown.Item>3 étoiles</Dropdown.Item>
                    <Dropdown.Item>4 étoiles</Dropdown.Item>
                    <Dropdown.Item>5 étoiles</Dropdown.Item>
                </DropdownButton>
                </Form.Group>
                </Form.Row>
                <Form.Group style={{

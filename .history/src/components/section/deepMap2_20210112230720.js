            ...
            {<div style={{
                ...
                {RegionDetails.map(details => (
                    <Dropdown.Item  onClick={()=>{
                        ...
                        handleRegion(details.region, details.coordinates[0], details.coordinates[1], details.zoom)}}>{details.region}</Dropdown.Item>
                    ))}
                </DropdownButton>
                </Form.Group>
                ...
                {region === "PARIS" ? deptDetails[number].map(details => (
                    <Dropdown.Item  onClick={()=>{
                        ...
                        handleDepartement(details.nom, details.coordinates[0], details.coordinates[1]),details.zoom}}>{details.nom}</Dropdown.Item>

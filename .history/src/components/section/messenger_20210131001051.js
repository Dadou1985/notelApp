            ...
            firebase.storage
              ...
              .then(url => {
                const uploadTask = () => {
                    ...
                    firebase.addNote({documentId: user.displayName, noteId: title, author: user.username, text: note, img:  status: status, hour: time, markup: marker, userId: user.uid, date: date})
                    setShowModal(false)
                }

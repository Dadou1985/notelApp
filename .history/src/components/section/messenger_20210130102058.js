...
import BlueCircle from '../../svg/yellow-circle.svg'
...
const Messenger = () =>{
    ...
    const renderSwitch = (status) => {
        switch(status) {
          case 'important':
            return <img src={AngryBear} alt="important" style={{width: "30%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
          case 'urgent':
            return <img src={Smile} alt="urgent" style={{width: "25%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
          default:
            return <img src={Chill} alt="info" style={{width: "30%", borderRadius: "50px", cursor: "pointer"}} onClick={handleShowMoodList} />
        }
      }

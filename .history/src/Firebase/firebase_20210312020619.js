...
class Firebase {
  ...
  async adminWorkspaceRegister({email, username, userId, refSpace}) {
  ...
  hotelDataOnAir({region, departement, initialFilter, operator, filter}){
    ...
    .where(initialFilter, operator, filter)
  } 

...
async addIziMessage({author, text, date, hour, userId}){
  return this.db.collection("IziLife")
  .doc("FunSpace")
...
async addCommentOnHotel({hotelId, region, departement, commentTitle, status, bestOf, bullShift, team, management, customer, wage}){
  ...
  .doc(hotelId)
  .adupdated({
    team: firebase.firestore.FieldValue.arrayUnion("greater_virginia"),
    management: firebase.firestore.FieldValue.arrayUnion("greater_virginia"),
    customer: firebase.firestore.FieldValue.arrayUnion("greater_virginia"),
    wage: firebase.firestore.FieldValue.arrayUnion("greater_virginia"),
  })
